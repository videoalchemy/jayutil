...
If you only check out one code example, make sure it’s this one, 
it’s the most fun! It’s a quick ‘hack’ to get a full screen screenshot. 
Really full screen, so not just the sketch’s window. 
